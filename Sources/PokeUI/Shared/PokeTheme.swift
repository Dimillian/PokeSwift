...
private extension PokeThemeResolvedPalette {
    static let light = PokeThemeResolvedPalette(
        ...
        panelGlassTint: .init(red: 0.91, green: 0.93, blue: 0.96, alpha: 0.32),
        ...
        menuFocusFill: .init(red: 0.84, green: 0.87, blue: 0.93, alpha: 0.3),
        menuIdleFill: .init(red: 1, green: 1, blue: 1, alpha: 0.12),
        menuFocusGlass: .init(red: 0.87, green: 0.9, blue: 0.96, alpha: 0.42),
        ...
        appBackgroundTop: .init(red: 0.95, green: 0.95, blue: 0.96),
        appBackgroundMiddle: .init(red: 0.86, green: 0.87, blue: 0.89),
        appBackgroundBottom: .init(red: 0.74, green: 0.76, blue: 0.79),
        appHighlightGlow: .init(red: 1, green: 1, blue: 1, alpha: 0.42),
        appAccentGlow: .init(red: 0.8, green: 0.84, blue: 0.92, alpha: 0.18),
        appDepthShadow: .init(red: 0.29, green: 0.31, blue: 0.37, alpha: 0.08),
        gameBoyWordmark: .init(red: 0.17, green: 0.22, blue: 0.68),
        dialogueBorder: .init(red: 0, green: 0, blue: 0),
        dialoguePaper: .init(red: 0.95, green: 0.95, blue: 0.96),
        dialogueInsetBorder: .init(red: 0, green: 0, blue: 0),
        dialogueFill: .init(red: 0.98, green: 0.98, blue: 0.99),
        ...
        field: .init(
            ink: .init(red: 0.14, green: 0.15, blue: 0.17),
            outline: .init(red: 0, green: 0, blue: 0),
            cardFill: .init(red: 0.88, green: 0.89, blue: 0.91),
            slotFill: .init(red: 0.8, green: 0.82, blue: 0.85),
            leadSlotFill: .init(red: 0.74, green: 0.77, blue: 0.81),
            track: .init(red: 0.57, green: 0.6, blue: 0.66),
            portraitFill: .init(red: 0.78, green: 0.8, blue: 0.84),
            stageOuter: .init(red: 0.69, green: 0.72, blue: 0.76),
            stageMiddle: .init(red: 0.8, green: 0.82, blue: 0.86),
            stageInner: .init(red: 0.92, green: 0.93, blue: 0.95),
            glassTint: .init(red: 0.9, green: 0.92, blue: 0.96, alpha: 0.36),
            accentGlassTint: .init(red: 0.8, green: 0.84, blue: 0.92, alpha: 0.44),
            interactiveGlassTint: .init(red: 0.93, green: 0.94, blue: 0.97, alpha: 0.36),
            hoverCardGlassTint: .init(red: 0.83, green: 0.88, blue: 0.96, alpha: 0.38),
            hoverCardBackgroundTint: .init(red: 0.84, green: 0.87, blue: 0.93, alpha: 0.18),
            shellBackdrop: .init(red: 0.92, green: 0.92, blue: 0.94),
            shellBackdropShadow: .init(red: 0.28, green: 0.31, blue: 0.37)
        )
    )

    static let retroDark = PokeThemeResolvedPalette(
        primaryText: .init(red: 0.93, green: 0.94, blue: 0.97),
        secondaryText: .init(red: 0.86, green: 0.88, blue: 0.92, alpha: 0.78),
        tertiaryText: .init(red: 0.78, green: 0.81, blue: 0.86, alpha: 0.56),
        disabledText: .init(red: 0.72, green: 0.75, blue: 0.8, alpha: 0.42),
        classicBackground: .init(red: 0.04, green: 0.05, blue: 0.05),
        panelBackground: .init(red: 0.1, green: 0.11, blue: 0.11, alpha: 0.8),
        panelGlassTint: .init(red: 0.18, green: 0.2, blue: 0.24, alpha: 0.3),
        panelOutline: .init(red: 0.58, green: 0.63, blue: 0.73, alpha: 0.15),
        plainPanelFill: .init(red: 0.09, green: 0.1, blue: 0.1),
        placeholderFill: .init(red: 0.55, green: 0.65, blue: 0.9, alpha: 0.14),
        menuFocusFill: .init(red: 0.16, green: 0.18, blue: 0.24, alpha: 0.46),
        menuIdleFill: .init(red: 0.09, green: 0.1, blue: 0.11, alpha: 0.62),
        menuFocusGlass: .init(red: 0.24, green: 0.28, blue: 0.38, alpha: 0.34),
        menuIdleGlass: .init(red: 0.14, green: 0.16, blue: 0.19, alpha: 0.26),
        menuFocusStroke: .init(red: 0.58, green: 0.67, blue: 0.86, alpha: 0.24),
        menuIdleStroke: .init(red: 0.4, green: 0.46, blue: 0.56, alpha: 0.14),
        ...
        appHighlightGlow: .init(red: 0.76, green: 0.84, blue: 0.98, alpha: 0.05),
        appAccentGlow: .init(red: 0.32, green: 0.42, blue: 0.68, alpha: 0.12),
        appDepthShadow: .init(red: 0, green: 0, blue: 0, alpha: 0.4),
        gameBoyWordmark: .init(red: 0.72, green: 0.73, blue: 0.76),
        dialogueBorder: .init(red: 0.63, green: 0.69, blue: 0.8, alpha: 0.22),
        dialoguePaper: .init(red: 0.08, green: 0.09, blue: 0.09),
        dialogueInsetBorder: .init(red: 0.03, green: 0.03, blue: 0.03),
        dialogueFill: .init(red: 0.13, green: 0.15, blue: 0.18),
        dialogueDotSoft: .init(red: 0.48, green: 0.58, blue: 0.72, alpha: 0.2),
        dialogueDotMid: .init(red: 0.62, green: 0.74, blue: 0.9, alpha: 0.4),
        dialogueDotStrong: .init(red: 0.8, green: 0.88, blue: 0.99, alpha: 0.72),
        ...
        field: .init(
            ink: .init(red: 0.93, green: 0.94, blue: 0.97),
            outline: .init(red: 0.72, green: 0.76, blue: 0.84, alpha: 0.22),
            cardFill: .init(red: 0.1, green: 0.11, blue: 0.13),
            slotFill: .init(red: 0.13, green: 0.15, blue: 0.18),
            leadSlotFill: .init(red: 0.16, green: 0.18, blue: 0.22),
            track: .init(red: 0.18, green: 0.21, blue: 0.25),
            portraitFill: .init(red: 0.15, green: 0.17, blue: 0.2),
            stageOuter: .init(red: 0.07, green: 0.08, blue: 0.09),
            stageMiddle: .init(red: 0.1, green: 0.11, blue: 0.13),
            stageInner: .init(red: 0.14, green: 0.16, blue: 0.19),
            glassTint: .init(red: 0.19, green: 0.22, blue: 0.28, alpha: 0.28),
            accentGlassTint: .init(red: 0.25, green: 0.31, blue: 0.42, alpha: 0.34),
            interactiveGlassTint: .init(red: 0.14, green: 0.16, blue: 0.2, alpha: 0.34),
            hoverCardGlassTint: .init(red: 0.28, green: 0.36, blue: 0.5, alpha: 0.32),
            hoverCardBackgroundTint: .init(red: 0.12, green: 0.15, blue: 0.2, alpha: 0.24),
            shellBackdrop: .init(red: 0.08, green: 0.08, blue: 0.09),
            shellBackdropShadow: .init(red: 0, green: 0, blue: 0, alpha: 0.52)
        )
    )
}
