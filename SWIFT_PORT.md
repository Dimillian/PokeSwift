...
- Oak Lab rival progression for the accepted M3 slice: starter species now carry extracted base-exp and growth-rate data, the first rival battle grants source-driven trainer EXP, the starter levels up when thresholds are crossed, and that EXP state persists through native saves
